...
const SideNav = () => {
    const SideNav_close = () => { document.getElementById("side-nav")?.classList.remove("opened"); }

    return (
        <div className="side-nav side-nav__left" id="side-nav">
                                ...
                                <div className="axil-contact-info">
                                    <address className="address">
                                        <p className="m-b-xs-30  mid grey-dark-three ">
                                            Theodore Lowe, Ap#867-859<br/>Sit Rd, Azusa New York</p>
            ...
            <div className="close-sidenav" id="close-sidenav" onClick={SideNav_close}>
                <div></div>
                <div></div>
            </div>
        </div>
